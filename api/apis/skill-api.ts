...
export const SkillApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async skillGet(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Skill>>> {
            const localVarAxiosArgs = await SkillApiAxiosParamCreator(configuration).skillGet(options);
...
export const SkillApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        skillGet(options?: any): AxiosPromise<Array<Skill>> {
            return SkillApiFp(configuration).skillGet(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SkillApi extends BaseAPI {
    ...
    public skillGet(options?: any) {
        return SkillApiFp(this.configuration).skillGet(options).then((request) => request(this.axios, this.basePath));
    }
}
